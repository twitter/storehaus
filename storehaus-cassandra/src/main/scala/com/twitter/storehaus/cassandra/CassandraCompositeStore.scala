 ...
 *
 *  For an explanation of input params please consult CassandraStore
 *
...
object CassandraCompositeStore {
  ...
  def apply[RK, CK, V : CassandraSerializable](
      ...
      keySerializers: HList,
      colSerializers: HList,
      ...
      ttl: Option[Duration] = CassandraConfiguration.DEFAULT_TTL_DURATION): CassandraCompositeStore[RK, CK, V] = {
    new CassandraCompositeStore[RK, CK, V](keyspace, columnFamily, keySerializers, colSerializers, valueColumnName, policy, poolSize, ttl)
  }
